...
export var ParserRules:NearleyRule[] = [
    ...
    {"name": "Main$ebnf$1$subexpression$1$ebnf$1", "symbols": ["Main$ebnf$1$subexpression$1$ebnf$1", {"literal":"\n"}], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Main$ebnf$1$subexpression$1", "symbols": ["Main$ebnf$1$subexpression$1$ebnf$1", "Statement"], "postprocess": d => d[1][0]},
    ...
    {"name": "Main", "symbols": ["Statement", "Main$ebnf$1", "Main$ebnf$2"], "postprocess":  (d, idx) =>
        ({
          type: "Program",
    ...
    {"name": "Comment", "symbols": [{"literal":"#"}, "Comment$ebnf$1"], "postprocess":  (d, idx) => ({
          type: "Comment",
          value: d[1].join('').trim(),
    ...
    {"name": "EdgeChain$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"-"}, {"literal":">"}], "postprocess": (d) => d.join('')},
    {"name": "EdgeChain$ebnf$1$subexpression$1", "symbols": ["sl_", "EdgeChain$ebnf$1$subexpression$1$string$1", "sl_", "NodeList"], "postprocess": d => d[3]},
    {"name": "EdgeChain$ebnf$1", "symbols": ["EdgeChain$ebnf$1$subexpression$1"]},
    {"name": "EdgeChain$ebnf$1$subexpression$2$string$1", "symbols": [{"literal":"-"}, {"literal":">"}], "postprocess": (d) => d.join('')},
    {"name": "EdgeChain$ebnf$1$subexpression$2", "symbols": ["sl_", "EdgeChain$ebnf$1$subexpression$2$string$1", "sl_", "NodeList"], "postprocess": d => d[3]},
    {"name": "EdgeChain$ebnf$1", "symbols": ["EdgeChain$ebnf$1", "EdgeChain$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "EdgeChain$ebnf$2$subexpression$1", "symbols": ["sl_", "PropertyList"], "postprocess": d => d[1]},
    {"name": "EdgeChain$ebnf$2", "symbols": ["EdgeChain$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "EdgeChain$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "EdgeChain", "symbols": ["NodeList", "EdgeChain$ebnf$1", "EdgeChain$ebnf$2"], "postprocess":  (d, idx) => ({
          type: 'EdgeChain',
    ...
    {"name": "PropertyList$ebnf$1$subexpression$1", "symbols": ["delimiter", "Property"], "postprocess": d => d[1]},
    {"name": "PropertyList$ebnf$1", "symbols": ["PropertyList$ebnf$1", "PropertyList$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "PropertyList", "symbols": [{"literal":"["}, "sl_", "Property", "PropertyList$ebnf$1", "sl_", {"literal":"]"}], "postprocess":  (d, idx) => ({
          type: 'PropertyList',
    ...
    {"name": "Property$ebnf$1", "symbols": ["Property$ebnf$1", /[a-zA-Z0-9_]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Property$subexpression$1", "symbols": ["jsonfloat"]},
    {"name": "Property$subexpression$1", "symbols": ["dqstring"]},
    {"name": "Property", "symbols": ["Property$ebnf$1", "sl_", {"literal":"="}, "sl_", "Property$subexpression$1"], "postprocess":  (d, idx) => ({
          type: 'Property',
          name: d[0].join(''),
          value: d[4][0],
          loc: {
    ...
    {"name": "NodeList$ebnf$1$subexpression$1", "symbols": ["delimiter", "Node"], "postprocess": d => d[1][0]},
    {"name": "NodeList$ebnf$1", "symbols": ["NodeList$ebnf$1", "NodeList$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "NodeList", "symbols": ["Node", "NodeList$ebnf$1"], "postprocess":  (d, idx) => ({
          type: 'NodeList',
          nodes: flatten(d),
          loc: {
            start: { index: idx }
    ...
    {"name": "VariableDefinition", "symbols": ["Identifier", "sl_", {"literal":"="}, "sl_", "Literal"], "postprocess":  (d, idx) => ({
    ...
    {"name": "Literal", "symbols": ["dqstring"], "postprocess":  (d, idx) => ({
          type: 'Literal',
          value: d[0],
          location: {
            start: { index: idx }
    ...
    {"name": "Identifier", "symbols": ["Identifier$ebnf$1"], "postprocess":  (d, idx) => ({
          type: 'Identifier',
          name: d[0].join(''),
          location: {
            start: { index: idx }
    ...
    {"name": "delimiter$subexpression$1", "symbols": ["sl_", {"literal":","}, "sl_"]},
    {"name": "delimiter", "symbols": ["delimiter$subexpression$1"]},
    {"name": "sl_$ebnf$1", "symbols": []},
    {"name": "sl_$ebnf$1", "symbols": ["sl_$ebnf$1", "slwschar"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "sl_", "symbols": ["sl_$ebnf$1"], "postprocess": nuller},
    {"name": "sl__$ebnf$1", "symbols": ["slwschar"]},
    {"name": "sl__$ebnf$1", "symbols": ["sl__$ebnf$1", "slwschar"], "postprocess": (d) => d[0].concat([d[1]])},
